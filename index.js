...
app.post('/api/newTicket', async (req, res) => {
	...
	try {
        ...
        const mailtoUser = {
            ...
            html: '<p>Dear '+req.body.fullname+',</p> <p>Greetings!</p> <a>You have requested for a IT support.</a><br> <a>Please have patience until the support is provided.</a><br><br> <a style="font-weight:bold ; font-size:14px">Support Description:</a><br> <a style="color:darkblue ; font-weight:bold">Support Type: </a><a style="color:darkblue">'+req.body.problem_type+'</a><br> <a style="color:darkblue ; font-weight:bold">Subject: </a><a style="color:darkblue">'+req.body.subject+'</a><br> <a style="color:darkblue ; font-weight:bold">Priority: </a><a style="color:darkblue">'+req.body.priority+'</a><br> <a style="color:darkblue; font-weight:bold">Support Needed On: </a><a style="color:darkblue">'+req.body.support_needed_on+'</a> <br><br> <a style="font-style: italic ; color:blue">THIS IS AN AUTOMATED MESSAGE - PLEASE DO NOT REPLY DIRECTLY TO THIS EMAIL.</a> <br> <p>Regards,</p> <a style="font-weight:bold">IT Department</a><br><a style="font-style: italic ; font-size:12px ; font-color:lightgrey">Bangladesh Youth Leadership Center</a><br><a style="font-style: italic ; font-size:12px ; font-color:lightgrey">Medona Tower (Level 12), 28 Mohakhali C/A, Dhaka 1213.</a>'
        };
		...
		const mailtoAdmin = {
            ...
            to: maillist,
            subject: "IT Support Request",
            html: '<p>Dear IT Support Team,</p> <p>Greetings!</p> <a>An user have made a IT support request.</a><br> <a>Please check your dashboard for more details.</a><br><br> <a style="font-weight:bold ; font-size:14px">Support Description:</a><br> <a style="color:darkblue ; font-weight:bold">Department: </a><a style="color:darkblue">'+req.body.department+'</a><br> <a style="color:darkblue ; font-weight:bold">Name: </a><a style="color:darkblue">'+req.body.fullname+'</a><br> <a style="color:darkblue ; font-weight:bold">Designation: </a><a style="color:darkblue">'+req.body.designation+'</a><br> <a style="color:darkblue ; font-weight:bold">Support Type: </a><a style="color:darkblue">'+req.body.problem_type+'</a><br> <a style="color:darkblue ; font-weight:bold">Subject: </a><a style="color:darkblue">'+req.body.subject+'</a><br> <a style="color:darkblue; font-weight:bold">Support Needed On: </a><a style="color:darkblue">'+req.body.support_needed_on+'</a><br> <a style="color:darkblue; font-weight:bold">Details: </a><a style="color:darkblue">'+req.body.description+'</a> <br><br> <a style="font-style: italic ; color:blue">THIS IS AN AUTOMATED MESSAGE - PLEASE DO NOT REPLY DIRECTLY TO THIS EMAIL.</a> <br> <p>Regards,</p> <a style="font-weight:bold">'+req.body.department+'</a><br><a style="font-style: italic ; font-size:12px ; font-color:lightgrey">Bangladesh Youth Leadership Center</a><br><a style="font-style: italic ; font-size:12px ; font-color:lightgrey">Medona Tower (Level 12), 28 Mohakhali C/A, Dhaka 1213.</a>'
        };
...
app.put("/ticketSolved/:id" , async (req, res) => {
    ...
    try{
        ...
        const mailtoUser = {
            ...
            html: '<p>Dear '+req.body.fullname+',</p> <a>'+message+'</a><br> <a>Thanks for your patience.</a><br><br> <a style="font-weight:bold ; font-size:14px">Support Description:</a><br> <a style="color:darkblue ; font-weight:bold">Support Type: </a><a style="color:darkblue">'+req.body.problem_type+'</a><br> <a style="color:darkblue ; font-weight:bold">Subject: </a><a style="color:darkblue">'+req.body.subject+'</a><br> <a style="color:darkblue ; font-weight:bold">Priority: </a><a style="color:darkblue">'+req.body.priority+'</a><br> <a style="color:darkblue; font-weight:bold">Support Needed On: </a><a style="color:darkblue">'+req.body.support_needed_on+'</a> <br><br> <a style="font-style: italic ; color:blue">THIS IS AN AUTOMATED MESSAGE - PLEASE DO NOT REPLY DIRECTLY TO THIS EMAIL.</a> <br> <p>Regards,</p> <a style="font-weight:bold">IT Department</a><br><a style="font-style: italic ; font-size:12px ; font-color:lightgrey">Bangladesh Youth Leadership Center</a><br><a style="font-style: italic ; font-size:12px ; font-color:lightgrey">Medona Tower (Level 12), 28 Mohakhali C/A, Dhaka 1213.</a>'
        };
